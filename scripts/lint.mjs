...
const failures = [];
const textExtensions = new Set([".mjs", ".json", ".md", ".yml", ".yaml", ".txt"]);
...
for (const file of files) {
  ...
  if (textExtensions.has(path.extname(file)) || ["LICENSE", ".gitignore", ".editorconfig"].includes(path.basename(file))) {
